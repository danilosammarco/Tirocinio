...
#        self.update()
    ...
    def saveAnnotation(self):
        global folderAnnotation, currentAddress, currentImage
        currAdd=currentAddress+"/"+currentImage
        newAdd=folderAnnotation+"/images/"+currentImage
        shutil.copy(currAdd,newAdd)
        print("CURR:"+currAdd)
        print("NEW:"+newAdd)
        with open (folderAnnotation+'/annotation.csv', mode='w') as employee_file:
